# Tank Game
Tanks in C++. Use arrow keys to move tank up, down left right. Used 'A' and 'D' keys to rotate turret. Use 'W' to fire missile. Use 'F' to drop bomb [Section reqquires edits]. Designed for demonstration purposes, the program currently supports multiplayer mode on a single computer.
